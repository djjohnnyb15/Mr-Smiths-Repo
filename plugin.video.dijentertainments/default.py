...
twittbg         = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'twittbg.jpg'))
...
def GetList():
        ...
        addLink('[COLOR blue]Twitter[/COLOR] [COLOR WHITE]Feed[/COLOR]','url',2,twitt,twittbg)
