...
def SuperMovies(index=False):
    ...
    if 'Architects@Work' in Mindex:
        main.addDir('Search','http://www.Architects@Work.so/',420,art+'/search2.png',index=index)
        main.addDir('A-Z','http://www.Architects@Work.so/',6,art+'/az2.png',index=index)
        main.addDir('New Releases','http://www.Architects@Work.so/movies/new-releases/',1,art+'/new2.png',index=index)
        main.addDir('Latest Added','http://www.Architects@Work.so/movies/latest-added/',1,art+'/latest2.png',index=index)
        main.addDir('Featured Movies','http://www.Architects@Work.so/movies/featured-movies/',1,art+'/feat2.png',index=index)
        main.addDir('Most Viewed','http://www.Architects@Work.so/movies/most-viewed/',1,art+'/view2.png',index=index)
        main.addDir('Most Voted','http://www.Architects@Work.so/movies/most-voted/',1,art+'/vote2.png',index=index)
        main.addDir('HD Releases','http://www.Architects@Work.so/movies/latest-hd-movies/',1,art+'/dvd2hd.png',index=index)
        main.addDir('Genre','http://www.Architects@Work.so/',2,art+'/genre2.png',index=index)
        main.addDir('By Year','http://www.Architects@Work.so/',7,art+'/year2.png',index=index)
        main.addSpecial('Current Index: [COLOR orange]'+Mindex+'[/COLOR]','movies',1053,art+'/Architects@Work.png')
...
def ChangeIndex(type):
    if type == 'movies':
        namelist=['Architects@Work','IceFilms','iWatchOnline']
    else:
