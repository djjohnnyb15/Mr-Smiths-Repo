import xbmc,xbmcaddon,xbmcgui,xbmcplugin,urllib,urllib2,os,re,sys,datetime,shutil,urlresolver,random,base64
from resources.libs.common_addon import Addon

addon_id        = 'plugin.video.KidzWorld'
addon           = Addon(addon_id, sys.argv)
fanart          = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id , 'fanart.jpg'))
icon            = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'icon.png'))
twitt            = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'twitt.png'))
baseurl         = base64.decodestring ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2Rqam9obm55YjE1L2Rpai1lbnRlcnRhaW5tZW50cy9tYXN0ZXIvRGlyZWN0b3J5L2Rpal9lbnRlcnRhaW5tZW50c19EaXJlY3RvcnkueG1s')
